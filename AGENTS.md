...
- Documentation maintenance stays read-only: do not execute package-manager, install, build, test, lint, format, generate, migrate, release, or repository scripts unless the user explicitly requests a named command; even then, never execute a command documented as mutating files.
