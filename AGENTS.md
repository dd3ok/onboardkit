...
- No user-facing helper artifacts exist; `SKILL.md`, README, AGENTS, and UI metadata share the instruction-only boundary.
...
- Durable guidance has one canonical destination before deletion. Audit, cleanup, or maintenance alone does not authorize deletion; clean audits are no-ops.
