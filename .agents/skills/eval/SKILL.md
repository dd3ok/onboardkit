---
name: eval
description: Design evals, run available deterministic checks, and compare baseline, workflow-guide, AGENTS.md-only, docs-index, and hybrid evidence workflows.
---


# Eval Guide

Use this guide when changing workflow design, guide behavior, docs indexing, or verification policy. In the current MVP, treat dynamic or LLM-based eval execution as design/backlog work unless an explicit deterministic runner is available.
...
4. Compare baseline, workflow-guide, AGENTS.md-only, docs-index, and hybrid modes.
