...
7. Before deletion, preserve durable guidance and verify it in its destination as a separate completed step; only then delete. Require both explicit deletion intent and user-named literal paths or file-matching globs; never broaden approval or treat directories as approval.
